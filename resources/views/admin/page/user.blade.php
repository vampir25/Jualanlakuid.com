                ...
                <tbody>
                    @foreach ($data as $y => $x)
                        <tr class="align-middle">
                            ...
                            <td>
                                <span
                                    class='badge text-bg-{{ $x->role === 1 ? 'info' : 'success' }}'>{{ $x->role === 0 ? 'Member' : 'Admin' }}</span>
                            </td>
                            <td>
                                <span
                                    class="badge text-bg-{{ $x->is_active === 0 ? 'success' : 'danger' }}">{{ $x->is_active === 1 ? 'Aktif' : 'tidak Aktif' }}</span>
                            </td>
                            <td>
