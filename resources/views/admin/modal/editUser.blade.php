...
<form action="{{ route('updateDataUSer', $data->id ) }}" enctype="multipart/form-data" method="POST">
    ...
    <div class="modal-body">
        <div class="mb-3 row">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control-plaintext" id="nik" name="nik" value="{{ $data->nik }}" readonly>
            </div>
        </div>
        <div class="mb-3 row">
            <label for="name" class="col-sm-5 col-form-label">Nama Karyawan</label>
            <div class="col-sm-7">
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="nama"
        ...
        <div class="mb-3 row">
            <label for="tlp" class="col-sm-5 col-form-label">Telephone Karyawan</label>
            <div class="col-sm-7">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-7">
                <select class="form-control" id="role" name="role">
                    ...
                    <option value="1" {{ $data->role == 0 ? 'selected' : '' }}>Admin</option>
                    <option value="2" {{ $data->role == 1 ? 'selected' : '' }}>Member</option>
                </select>
            </div>
        </div>
