            ...
            <div class="col-sm-8">
                <div class="card">
                    <div class="card-body ekspedisi">
                        ...
                        <!-- <div class="row mb-3">
                            <label for="ukuran" class="col-form-label col-sm-3">Ukuran</label>
                            <div class="col-sm-9">
                                <select name="ukuran" class="form-control eksp" id="ukuran">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="ekspedisi" class="form-control eksp" id="ekspedisi">
                                    ...
                                    <option value="jnt">Ambil di Toko</option>
                                    <option value="jne">Diantar</option>
                                </select>
                            </div>
                        </div>
                    </div>
