                                ...
                                <div class="accordion-body">
                                    <div class="d-flex flex-column gap-4">
                                        <div class="d-flex flex-row gap-3">
                                            <input type="checkbox" name="kategory" class="kategory" value="baju">
                                            <span>Baju</span>
                                        </div>
                                        <div class="d-flex flex-row gap-3">
                                            <input type="checkbox" name="kategory" class="kategory" value="">
                                            <span>Celana</span>
                                        </div>
                                    </div>
                                </div>
                ...
                @foreach ($data as $p)
                    <div class="card" style="width:200px;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="m-0" style="font-size: 14px;"> {{ $p->size }} </p>
